...
def greedy_matching_based(G):
    ...
    Theoretical guarantee: |C| ≤ 2|M| ≤ 2|OPT|
    """
...
print("\n🔬 COMPARATIVE ANALYSIS OF GREEDY STRATEGIES")
print("="*60)
...
print("\n📊 GENERATING MAIN COMPARISON VISUALIZATION...")
...
print("\n🎨 GENERATING ALGORITHM DEMONSTRATION...")
...
print("\n📐 GENERATING RADIUS COMPARISON PLOT...")
...
print("✅ Generated: radius_comparison.png")

# ============================================================================
# 7. TABLE AND FILE GENERATION
# ============================================================================

print("\n📄 GENERATING FINAL PUBLICATION TABLE...")
...
print("\n✅ FINAL LaTeX TABLE FOR PUBLICATION:")
print("="*70)
...
print("="*70)
print("1. 📊 algorithm_comparison.png - Main comparison (4 subplots)")
print("2. 🎨 algorithm_demo.png - Algorithm demonstration")
print("3. 📈 scalability_plot.png - Running time scalability")
print("4. 📐 radius_comparison.png - Radius effect comparison")
print("5. 📋 final_results_table.tex - LaTeX table for paper")
print("6. 📄 algorithm_comparison.csv - Raw data")
